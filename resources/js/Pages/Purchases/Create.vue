                ...
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12" sm="4" md="2">
                            <v-select readonly :items="payment_methods" v-model="datosMetPago" dense
                                hint="Contado/crédito" item-text="description" item-value="id" label="Contado/crédito"
                                outlined return-object>
                            </v-select>
                        </v-col>

                        <v-col cols="12" sm="4" md="3">
                            <v-select v-if="parseFloat(form.total) > 0" readonly dense hint="Moneda"
                                v-model="datosMoneda" :items="coins" item-text="code" item-value="id" label="Moneda"
                                outlined return-object>
                            </v-select>
                            <v-select v-else dense hint="Moneda" v-model="datosMoneda" :items="coins" item-text="code"
                                item-value="id" label="Moneda" outlined return-object>
                            </v-select>
                        </v-col>
                        ...
                        <v-col cols="12" sm="4" md="2">
                            ...
                            <v-text-field v-else v-model="tipoCambio" label="Tipo Cambio" type="number" min="0" outlined
                                dense>
                            </v-text-field>
                        </v-col>
                                                ...
                                                <v-card-text>
                                                    <v-container>
                                                        <v-row>
                                                            ...
                                                            <v-col cols="12" sm="6" md="3"
                                                                v-if="datosMoneda.code == 'USD' && editedItem.igv == 'IGV Incluido'
                                                                && tipoCambio != '' && editedItem.purchase_price != '' &&
                                                                parseFloat(tipoCambio) > 0 && editedItem.purchase_price > 0" v-show="true">
                                                                <v-text-field label="Precio S/."
                                                                    :value="(editedItem.purchase_price * parseFloat(tipoCambio)) + (editedItem.transporte * parseFloat(tipoCambio) / editedItem.amount)"
                                                                    type="number" readonly outlined dense>
                                                                </v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="6" md="3"
                                                                v-if="datosMoneda.code == 'USD' && editedItem.igv == 'Mas IGV'
                                                                && tipoCambio != '' && editedItem.purchase_price != '' &&
                                                                parseFloat(tipoCambio) > 0 && editedItem.purchase_price > 0" v-show="true">
                                                                <v-text-field label="Precio S/. +IGV"
                                                                    :value="(editedItem.purchase_price * parseFloat(tipoCambio) + ((editedItem.purchase_price * parseFloat(tipoCambio)) * 0.18)) + (editedItem.transporte * parseFloat(tipoCambio) / editedItem.amount)"
                                                                    type="number" readonly outlined dense>
                                                                </v-text-field>
                                                            </v-col>
                                                            ...
                                                            <v-col cols="12" sm="6" md="3"
                                                                ...
                                                                && editedItem.purchase_price != '' && editedItem.purchase_price > 0"
                                                                v-show="true">
        ...
        save() {
            if (this.editedIndex > -1) {
                ...
                if (this.datosMoneda.code == 'USD' && this.editedItem.igv == 'IGV Incluido') {
                    this.editedItem.precio_compra = (this.editedItem.purchase_price * this.tipoCambio) + (this.editedItem.transporte * this.tipoCambio / this.editedItem.amount)
                }
                if (this.datosMoneda.code == 'USD' && this.editedItem.igv == 'Mas IGV') {
                    this.editedItem.precio_compra = (this.editedItem.purchase_price * this.tipoCambio + ((this.editedItem.purchase_price * this.tipoCambio) * 0.18)) + (this.editedItem.transporte * this.form.exchange_rate / this.editedItem.amount)
                }
                ...
                if (this.datosMoneda.code == 'USD' && this.editedItem.igv == 'Mas IGV') {
                    this.editedItem.precio_compra = (this.editedItem.purchase_price * this.tipoCambio + ((this.editedItem.purchase_price * this.tipoCambio) * 0.18)) + (this.editedItem.transporte * this.tipoCambio / this.editedItem.amount)
                }
                if (this.datosMoneda.code == 'PEN' && this.editedItem.igv == 'IGV Incluido') {
                    this.editedItem.precio_compra = parseFloat(this.editedItem.purchase_price) + (this.editedItem.transporte / this.editedItem.amount)
                }

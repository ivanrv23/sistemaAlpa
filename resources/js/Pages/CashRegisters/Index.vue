    ...
    <admin-layout>
        ...
        <v-data-table :headers="headers" :items="desserts" sort-by="description" class="elevation-24" :search="search">
                ...
                <v-toolbar flat>
                    ...
                    <v-dialog v-model="dialogDelete" max-width="500px">
                        <v-card>
                            ...
                            <div class="ml-12">
                                • Se borrará toda información relacionada con la Caja
                            </div>
                            <v-card-actions>
                                <v-spacer></v-spacer>
            ...
            <template v-slot:[`item.actions`]="{ item }">
                <v-icon v-if="can('Editar Caja registradora')" small class="mr-2" @click="editItem(item)">
                    mdi-pencil
                </v-icon>

                <v-icon v-if="can('Eliminar Caja registradora')" small @click="deleteItem(item)">
                    mdi-delete
                </v-icon>
            </template>
        </v-data-table>
